...
<body style="background:url(huit.jpg);background-repeat:no-repeat;background-size:100%">
...
<h1 style="font-size:45pt;text-align:center;color:red;><b><span background="1.jpg">COMPLETED THANK YOU</b></h1>
<form action="information.php"method="post">
 <input type="submit" value="Go to HOmepage" style="font-size:20pt;color:red">
